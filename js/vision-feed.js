...
class MultiCameraManager {
  ...
  initAllCameraTargets() {
    // 1. CAM-MASTER Targets (Both Human & Wildlife)
    ...
    // 4. CAM-03 (River Basin Infiltrator in Fog)
    this.cameras['cam3'].targets = [
      {
        id: 'T-03',
        type: 'human',
        name: 'RIVER INFILTRATOR',
        x: 340,
        y: 180,
        width: 26,
        height: 60,
        ...
        confidence: 0.948,
        threatLevel: 'CRITICAL',
        thermalSignature: '36.9°C',
        coords: '32°44\'17"N 74°51\'01"E'
      }
    ];
  }
